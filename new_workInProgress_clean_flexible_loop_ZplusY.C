...
void run(string file){//, string file2){
  ...
  TH1F *h_big4MuVtxProb_before_big4MuVtx_Prob_Cut = new TH1F("h_big4MuVtxProb_before_big4MuVtx_Prob_Cut", "h_big4MuVtxProb_before_big4MuVtx_Prob_Cut",10000, 0, 1); h_big4MuVtxProb_before_big4MuVtx_Prob_Cut->SetXTitle("big4MuVtxProb_before_big4MuVtx_Prob_Cut");
...
//  std::cout << "myAdd(3,5) "<< myAdd(3,5) << std::endl;
 ...
 // double mu_mu_from_Z_Prob_Cut = 0.05; 
  ...
  double pfIso_Cut_Mu_from_Z = 9999; // 0.35; //9999; //0.35; //when value is 9999, this cut should never fire
  ...
  TFile *ntuple = new TFile("7Nov2022_ntuple_inputFileIs_2018_ZplusY_DPS_MC_phase1_flatFile_pfIsoNoCut_for_Zmu_pfIso0p7_for_upsiMu_10kBinsForProb.root", "RECREATE");
  TTree *aux;
